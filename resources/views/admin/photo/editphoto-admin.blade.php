...
<div class="content">
  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <?php $path = 'public/upload/news/'.date('d-m-Y').'/'?>
            ...
            <fieldset>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control daterange-single" placeholder="Chọn ngày đăng" value="{{$updatenews->News_Date}}" name="ndate">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-10">
                        <img class="img-responsive img-thumbnail" src="{{asset($path.$updatenews->News_Image)}}"/>
                      </div>
                   </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="editor1" class="ckeditor" rows="10" cols="80" name="ncontent">{{$updatenews->News_Content}}
</textarea>
                  </div>
            </fieldset>
